...
def update_db_on_failed_call(clinic_id: int, available_male_docs = None, available_female_docs = None):

  update_data = {'last_call_date': current_time(), 'last_call_success': False, "available_female_docs": available_female_docs, "available_male_docs": available_male_docs}
